...
contract PIBP2PPackablePrimary is PNFTokenReceiver, ERC223ReceivingContract {
    ...
    function offer(
        ...
        returns (bytes32)
    {
        require(isOfferer[msg.sender][_sellToken], "115");
        require(allowedOffer[_sellToken][_buyToken], "116");
