...
contract PIBP2PPackableFiatPrimary is PNFTokenReceiver, ERC223ReceivingContract {
    ...
    function offer(
        ...
        returns (bytes32)
    {
        require(isOfferer[msg.sender][_tokens[0]], "115");
        require(allowedOffer[_tokens[0]][_tokens[1]], "116");
