...
interface ERC721 {
    ...
    */
    ...
    event NewJson(uint indexed tokenId, uint[] json);
    event FakeToken(uint indexed tokenId);
    ...
    function getMetadata(uint256 _tokenId) external view returns(uint[10] memory);
